/**
 * 水墨山水背景（服务端渲染的静态 SVG）。
 * 各图层带 data-depth，由 InkScapeFX 做鼠标/滚动视差；
 * 云雾、瀑布、飞鸟、月晕的细微动效由 globals.css 中的 keyframes 驱动。
 */
export default function InkScape() {
  return (
    <div className="ink-bg" aria-hidden="true">
      <svg viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice">
        ...
        {/* 月与云（最远层） */}
        <g data-depth="4">
          <circle cx="1210" cy="170" r="180" fill="url(#moonHalo)" filter="url(#mistSoft)" className="moon-halo" />
        ...
        {/* 飞鸟：缓慢漂移 */}
        <g className="birds" style={{ stroke: 'var(--bg-bird)' }} strokeWidth="3" fill="none" strokeLinecap="round" opacity="0.45">
        ...
        <g data-depth="14">
          ...
          <g>
            <path
              d="M880 460 L 866 660"
              className="waterfall"
              style={{ stroke: 'var(--bg-waterfall)' }}
              strokeWidth="5"
              opacity="0.9"
              strokeLinecap="round"
            />
            <path
              d="M888 480 L 880 620"
              className="waterfall waterfall-thin"
              style={{ stroke: 'var(--bg-waterfall)' }}
              strokeWidth="2"
              opacity="0.7"
              strokeLinecap="round"
        ...
        {/* 云雾：缓慢流动 */}
        <ellipse cx="520" cy="640" rx="520" ry="66" style={{ fill: 'var(--bg-mist1)' }} opacity="0.8" filter="url(#mist)" className="mist-a" />
        <ellipse cx="1200" cy="700" rx="540" ry="76" style={{ fill: 'var(--bg-mist2)' }} opacity="0.8" filter="url(#mist)" className="mist-b" />
        <ellipse cx="800" cy="800" rx="920" ry="120" style={{ fill: 'var(--bg-mist3)' }} opacity="0.85" filter="url(#mistSoft)" className="mist-c" />
